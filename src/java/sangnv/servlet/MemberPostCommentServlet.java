 ...
 * @author Shang
 */
public class MemberPostCommentServlet extends HttpServlet {

    private final String VIEW_DETAIL_ACTION = "viewDetailAction";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Create DTO
            if (account != null && articleId != null && comment != null) {
                ArticleCommentDTO dto = new ArticleCommentDTO();
                dto.setArticleId(articleId);
                dto.setCommenter(account.getEmail());
                comment = comment.replaceAll("\n", "\\\n");
                dto.setContent(new String(comment.getBytes("iso-8859-1"), "utf-8"));
                boolean isPost = articleCommentDAO.postComment(dto);
                if (isPost) {
                    url = (String) siteMap.get(VIEW_DETAIL_ACTION);
                }
            }
