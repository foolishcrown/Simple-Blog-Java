 ...
 * @author Shang
 */
public class AdminViewDetailServlet extends HttpServlet {

    private final String VIEW_DETAIL_PAGE = "adminViewDetailPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Get article
            ArticleDTO dto = articleDAO.findArticleOnIdByAdmin(articleId);
            //Set request DTO
