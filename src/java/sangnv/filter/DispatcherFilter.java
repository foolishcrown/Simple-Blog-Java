...
public class DispatcherFilter implements Filter {
    ...
    private static final String HOME_PAGE = "searchAction";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (url != null) {
                ...
                if (url.contains("Member") || url.contains("postArticle")) {
                    if (dto == null || dto.getRoleId() != MyConstants.ROLE_MEMBER) {
                        url = (String) siteMap.get(HOME_PAGE);
                    }
                } else if (url.contains("Admin") || url.contains("admin")) {
                    if (dto == null || dto.getRoleId() != MyConstants.ROLE_ADMIN) {
                        url = (String) siteMap.get(HOME_PAGE);
                    }
                }
